      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            Marco {""}
            <span className=" xs:text-orange">Settembre</span>
          </p>
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Adipiscing arcu, in aliquam fringilla cursus. Elit arcu elementum
            viverra malesuada sem ac fauncibus dolor. Sagittis scelerisque.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            <div
              className="bg-deep-blue hovr:text-red transition duration-500 w-full h-full flex items-center justify-center 
    font-playfair px-10"
            >
              Parliamo
            </div>
