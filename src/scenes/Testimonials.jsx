      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          ...
          <p className="text-center text-xl">
            A auctor pharetra henrerit mattis amet etiam interdum platea.
          </p>
          <p className="font-playfair text-6xl text-end">”</p>
        </motion.div>
        <motion.div
        ...
        <motion.div
          className={`bg-orange ${testimonialStyles} before:content-person3`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
